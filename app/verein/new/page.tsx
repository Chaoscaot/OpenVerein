    ...
    <main className="w-screen h-screen flex items-center justify-center">
      <Card className="w-100">
        <CardHeader>
          ...
          <CardDescription>
            Erstelle hier deinen neuen Verein. Damit kannst du Mitglieder
            verwalten, Veranstaltungen planen und vieles mehr.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
              ...
              <form.Field
                ...
                validators={{
                  onChangeAsync: async (v) => {
                    ...
                    const exists = await convex.query(api.verein.nameExists, {
                      name: v.value,
                    });
                    if (exists) {
                      setNameState("error");
