  ...
  const links = [
    {
      ...
      description:
        "Pflege automatische und benutzerdefinierte Verteilerlisten für deinen Verein.",
      visible:
    ...
    },
    {
      ...
      label: "Mailversand",
      description:
        "Versende Nachrichten an eine oder mehrere Listen inklusive Empfängervorschau und Anhängen.",
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Wähle den Bereich, den du öffnen möchtest.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-2">
          {links.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              Für dieses Konto sind aktuell keine Kommunikationsbereiche
              freigeschaltet.
            </p>
          ) : (
            links.map((item) => (
