...
const features = [
  {
    ...
    description:
      "Verwalte alle Mitglieder deines Vereins an einem Ort. Persönliche Daten, Beiträge und Mitgliedschaftsstatus immer im Blick.",
  },
  {
    icon: CreditCard,
    title: "Beitragsverwaltung",
    description:
      "Flexible Beitragssätze, automatische Abbuchungen per SEPA-Lastschrift und lückenlose Nachverfolgung aller Zahlungen.",
  },
  {
    icon: FileText,
    title: "SEPA-Export",
    description:
      "Erstelle normkonforme SEPA-Dateien für deine Hausbank mit wenigen Klicks – bereit für die Weiterverarbeitung.",
  },
  {
    icon: Mail,
    title: "E-Mail-Kommunikation",
    description:
      "Sende professionelle E-Mails direkt aus OpenVerein heraus. Transaktionale Nachrichten automatisiert und zuverlässig.",
  },
  {
    icon: BarChart,
    title: "Übersicht & Berichte",
    description:
      "Behalte den Überblick über Wachstum, Finanzen und Aktivitäten deines Vereins mit übersichtlichen Dashboards.",
  },
  {
    icon: Shield,
    title: "Sicher & DSGVO-konform",
    description:
      "Deine Daten werden sicher gespeichert und verarbeitet. Vollständig konform mit der Datenschutz-Grundverordnung.",
  },
];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-6">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border border-primary/30 bg-primary/10 text-primary">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            OpenVerein bündelt Mitgliederverwaltung, Beitragsabrechnung und
            Kommunikation in einer modernen, intuitiven Plattform – damit du
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Von der Mitgliederpflege bis zur Buchhaltung – OpenVerein deckt
              alle wichtigen Bereiche der Vereinsarbeit ab.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="group rounded-xl border bg-card p-6 flex flex-col gap-4 transition-shadow hover:shadow-md"
              >
