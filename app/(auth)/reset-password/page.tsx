...
function ResetPasswordForm() {
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            if (!token) {
                setErrorMessage("Ungültiger oder abgelaufener Link. Bitte fordere einen neuen Link an.");
                return;
            }
            setSubmitting(true);
        ...
        return (
            <FieldGroup>
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-muted-foreground text-sm text-balance">Dieser Link ist ungültig oder abgelaufen. Bitte fordere einen neuen Link zum Zurücksetzen deines Passworts an.</p>
                </div>
                <Field>
        ...
        return (
            <FieldGroup>
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-muted-foreground text-sm text-balance">Dein Passwort wurde erfolgreich geändert. Du kannst dich jetzt anmelden.</p>
                </div>
                <Field>
        ...
        >
            <FieldGroup>
                <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <p className="text-muted-foreground text-sm text-balance">Gib dein neues Passwort ein. Es muss mindestens 8 Zeichen lang sein.</p>
                </div>
                <form.Field
                    name="password"
                    children={(field) => {
                ...
                <form.Field
                    ...
                    children={(field) => {
                        ...
                        return (
                            <Field>
                                <FieldLabel htmlFor={field.name}>Passwort bestätigen</FieldLabel>
                                <Input
                                    required
                                    type="password"
                                    id={field.name}
