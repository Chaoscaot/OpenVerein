...
const formSchema = z
    .object({
        name: z.string("Bitte gib deinen Namen ein").min(1, "Bitte gib deinen Namen ein"),
        email: z.email("Bitte gib deine Email ein").min(1, "Bitte gib deine Email ein"),
        password: z.string("Bitte gib dein Passwort ein").min(8, "Das Passwort muss mindestens 8 Zeichen lang sein"),
        confirmPassword: z.string("Bitte bestätige dein Passwort").min(1, "Bitte bestätige dein Passwort"),
    })
        ...
        >
            <FieldGroup>
                <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <p className="text-muted-foreground text-sm text-balance">Fülle das Formular aus, um dir ein Konto zu erstellen!</p>
                </div>
                <form.Field
                    name="name"
                    children={(field) => {
