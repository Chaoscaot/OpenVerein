                ...
                <FieldGroup>
                    ...
                    <form.Field
                        ...
                        children={(field) => {
                            const isInvalid = field.state.meta.isTouched && !field.state.meta.isValid;
                            return (
                                <Field data-invalid={isInvalid} className={ehrenmitglied ? "opacity-50 pointer-events-none" : ""}>
                    ...
                    <form.Field
                        ...
                        children={(field) => {
                            const isInvalid = field.state.meta.isTouched && !field.state.meta.isValid;
                            return (
                                <Field data-invalid={isInvalid} className={isSepa ? "" : "opacity-50 pointer-events-none"}>
