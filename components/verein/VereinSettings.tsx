...
const formSchema = z.object({
    ...
    postalCode: z.string().min(5, "Die Postleitzahl muss mindestens 5 Zeichen lang sein"),
...
export function VereinSettings({ verein }: { verein: Doc<"verein"> }) {
    ...
    const logoUrl = useQuery(api.files.getUrl, verein.logo ? { fileId: verein.logo } : "skip");
    ...
    return (
        ...
        >
            <SimpleCard title="Basisdaten" description="Grundlegende Informationen über den Verein">
                <FieldGroup>
                    <form.Field
                        name="name"
                        children={(field) => {
                                ...
                                <Field>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {field.state.value && (
                                                <Button type="button" variant="outline" onClick={handleLogoRemove}>
                ...
                <FieldGroup>
                    <form.Field
                        ...
                        children={(field) => {
                            ...
                            return (
                                <Field data-invalid={isInvalid}>
                                    <FieldLabel htmlFor={field.name}>Straße und Hausnummer</FieldLabel>
                                    <Input
                                        id={field.name}
                                        name={field.name}
                                        value={field.state.value}
            ...
            <SimpleCard title="Kontaktdaten" description="Kontaktinformationen des Vereins">
                <FieldGroup>
                    <form.Field
                        name="email"
                        children={(field) => {
                    ...
                    <form.Field
                        ...
                        children={(field) => {
                            ...
                            return (
                                <Field data-invalid={isInvalid}>
                                    <FieldLabel htmlFor={field.name}>Telefon (optional)</FieldLabel>
                                    <Input
                                        id={field.name}
                                        name={field.name}
                                        type="tel"
            ...
            <SimpleCard title="SEPA-Daten" description="SEPA-Lastschrift Informationen (optional)">
                <FieldGroup>
                    <form.Field
                        name="sepaIban"
                        children={(field) => {
